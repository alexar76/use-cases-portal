...
| Order | Idea | Why |
|---|---|---|
| 1 | **Fire + Weather Evidence Snapshot** | Callable ATLAS SKU; FIRMS and/or EFFIS; bounded weather; no unvalidated risk score |
| 2 | **Verified Watchbox** | Callable SKU with bbox, layer filtering, LIVE/SIM flags, matches, and content receipt |
| 3 | **Flood Hydrology Evidence** | Paying US flood-ops adjacency; uses shipped flood+river pairing; stay evidence not Floodbase |
| 4 | **Campus Physical Nowcast** | Paying DC/colo ops adjacency; vertical of situation.brief; siting software stays out of scope |
| 5 | **Situation Brief** | Higher-value composite; scoring remains a vanity metric until a buyer workflow exists |
| 6 | **08 Publisher kit** | Feeds density; without supply, briefs stay sparse |
| 7 | **02 Parametric trigger** | High upside but needs an MGA; flood/river are example inputs only |
| Later | crane, evidence export, cold-chain, grid, prediction, GNSS aviation product | Heavier ops / regulation / wrong sensor class |
