 ...
 */
import { currentLang, getDict, onDict } from "./i18n.js?v=20260910d";
...
const architecture = {
  ...
  product: { number: "05", titleKey: "proof.arch.product", key: "proof.arch.product.body", href: "ideas.html?v=20260910d&id=fire-hotspot" },
