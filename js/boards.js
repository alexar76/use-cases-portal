 ...
 */
import { mountAll } from "./preview3d.js?v=20260915b";
  ...
  async function load() {
    ...
    data.boards.forEach((board) => {
      ...
      board.ideas.forEach((slug) => {
        ...
        const chipClass =
          idea.chip === "live-wedge"
            ...
            : idea.chip === "live-rails"
              ? "chip-live"
              : idea.chip === "example" || idea.chip === "partner"
                ? "chip-partner"
                : idea.chip === "live"
                  ? "chip-live"
                  : "chip-idea";
        ...
        a.className = "icard";
        a.href = `${base}ideas.html?v=${DATA_VERSION}&id=${encodeURIComponent(slug)}`;
        a.innerHTML = `
          ...
          <div class="icard-body">
            ...
            ${idea.referenceDesk && idea.chip !== "example"
              ? `<p class="icard-ref"><span data-i18n="idea.ref.chip">reference desk</span> · <span data-i18n="desk.${idea.referenceDesk.id}.name"></span></p>`
              : ""}
